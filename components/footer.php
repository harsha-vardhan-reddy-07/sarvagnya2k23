            ...
            <div class="row">
                    ...
                    <ul style="color:#d3d3d3cf;">
                       ...
                       <li><a href="<?php echo $base_url ?>/terms_of_service.php">Terms Of Service</a></li>
                        <li><a href="<?php echo $base_url ?>/privacy_policy.php">Privacy Policy</a></li>
                         <li><a href="<?php echo $base_url ?>/refund_policy.php">Refund Policy</a></li>
                    </ul>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <ul style="color:#d3d3d3cf;">
                        ...
                        <li><a href="<?php echo $base_url ?>/gallery-2014">Sarvagnya - 2014</a></li>
                        <li><a href="<?php echo $base_url ?>/gallery-2015">Sarvagnya - 2015</a></li>
                    </ul>
                </div>
