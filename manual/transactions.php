...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-outline-success" data-toggle="modal" data-target="#add_transaction">Add
                Transactions</button>
        </div>
        <br>
        <div class="row">
...
?>
        ...
        <?php
                            ...
                            $query = "SELECT * FROM transactions WHERE a_m = 'manual'";
                            $query_run = mysqli_query($connection,$query);
            ...
            <table id="example_table" class="table table-bordered table-striped text-center">
                ...
                <tbody id="searchdata">
                    ...
                    <tr>
                        ...
                        <td><button type="button" class="btn btn-info update_transaction">Edit</button></td>
                        <td><button type="button" class="btn btn-danger delete_transaction">Delete</button></td>
                    </tr>
                    <?php
                    }
                    }
